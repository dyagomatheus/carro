...
<div class="col-lg-12">
    <div class="card spur-card">
        <div class="card-header">
            ...
            <div class="spur-card-title">Extrato por periodo</div>
        </div>
        <div class="card-body ">
            <form action="{{route('transaction.extract')}}" method="post">
                @csrf
                    <div class="form-group row">
                        <label for="start" class="col-md-4 col-form-label text-md-right">{{ __('desde o dia') }}</label>
                    ...
                    <div class="form-group row">
                        <label for="end" class="col-md-4 col-form-label text-md-right">{{ __('até o dia') }}</label>
