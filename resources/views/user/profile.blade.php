        ...
        <div class="col-xl-12">
            <div class="card spur-card">
                <div class="card-header">
                    ...
                    <div class="spur-card-title"> Meus Dados </div>
                </div>
                <div class="card-body ">
                    <div class="alert alert-info" role="alert">
                        Para mudar sua senha preencha o campo <strong>senha</strong>.
                    </div>
                    <form method="POST" action="{{ route('user.profile.update') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="password" type="password" class="form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password" placeholder="Preencha para alterar">
